...
$logPath     = Join-Path $desktop "Emir_Tech_Tools_W11_install_log.txt"
...
# ===== Windows 11 ISO Download Info =====
Write-Host ""
Write-Host "Windows 11 ISO Download Information" -ForegroundColor Cyan
Write-Host "If you need to download Windows 11 25H2 ISO, visit:" -ForegroundColor White
Write-Host "https://www.microsoft.com/software-download/windows11" -ForegroundColor Blue -NoNewline
Write-Host " (Official Microsoft Download)" -ForegroundColor Gray
Write-Host ""

# Show popup with download link
$isoInfoForm = New-Object System.Windows.Forms.Form
$isoInfoForm.Text = "Windows 11 ISO Download"
$isoInfoForm.StartPosition = "CenterScreen"
$isoInfoForm.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::FixedDialog
$isoInfoForm.MinimizeBox = $false
$isoInfoForm.MaximizeBox = $false
$isoInfoForm.AutoScaleMode = 'Dpi'
$isoInfoForm.MinimumSize = New-Object System.Drawing.Size(500, 200)
$isoInfoForm.Padding = New-Object System.Windows.Forms.Padding(15)
$isoInfoForm.Font = New-Object System.Drawing.Font("Segoe UI", 11)

$isoPanel = New-Object System.Windows.Forms.TableLayoutPanel
$isoPanel.Dock = 'Fill'
$isoPanel.RowCount = 4
$isoPanel.ColumnCount = 1
$isoPanel.AutoSize = $true

$isoTitle = New-Object System.Windows.Forms.Label
$isoTitle.Text = "Download Windows 11 ISO"
$isoTitle.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$isoTitle.ForeColor = [System.Drawing.Color]::FromArgb(65, 105, 225)
$isoTitle.AutoSize = $true
$isoTitle.Margin = New-Object System.Windows.Forms.Padding(0,0,0,10)
$isoPanel.Controls.Add($isoTitle)

$isoDesc = New-Object System.Windows.Forms.Label
$isoDesc.Text = "To use this installer, you need a Windows 11 25H2 ISO file.`r`n`r`nIf you don't have the ISO file yet, you can download it from the official Microsoft website by clicking the link below."
$isoDesc.Font = New-Object System.Drawing.Font("Segoe UI", 11)
$isoDesc.AutoSize = $true
$isoDesc.Margin = New-Object System.Windows.Forms.Padding(0,0,0,15)
...
$isoLink.ActiveLinkColor = [System.Drawing.Color]::FromArgb(0, 102, 204)
$isoLink.Margin = New-Object System.Windows.Forms.Padding(0,0,0,20)
$isoLink.Add_LinkClicked({
    try { 
        Start-Process "https://www.microsoft.com/software-download/windows11" | Out-Null 
        Log "Opened Windows 11 ISO download page."
    } catch {}
})
...
$isoContinue.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Bold)
$isoPanel.Controls.Add($isoContinue)

$isoInfoForm.Controls.Add($isoPanel)
$isoInfoForm.AcceptButton = $isoContinue

# Show the dialog
if ($isoInfoForm.ShowDialog() -ne [System.Windows.Forms.DialogResult]::OK) {
    throw "User cancelled at ISO download information."
}

Log "ISO download information shown and acknowledged."

# ===== CPU features helpers =====
...
function Show-CPUHeuristicDialog {
    ...
    $title.ForeColor = [System.Drawing.Color]::FromArgb(65, 105, 225)
    $title.AutoSize = $true
...
"Emir Tech Tools Windows 11 Installer Log" | Out-File -FilePath $logPath -Force -Encoding UTF8
Log "Script started."

# --- Console disclaimer banner ---
Write-Host ""
Write-Host "DISCLAIMER" -ForegroundColor Yellow
Write-Host "This tool helps you install/upgrade Windows 11." -ForegroundColor Gray
...
try {
    # ===== Intro  =====
    $form = New-Object System.Windows.Forms.Form
    $form.Text = "Emir Tech Tools - Windows 11 Installer"
    $form.StartPosition   = "CenterScreen"
    $form.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::FixedDialog
    $form.MinimizeBox     = $false
    $form.MaximizeBox     = $false
    ...
    $title = New-Object System.Windows.Forms.Label
    $title.Text = "Emir Tech Tools - Windows 11 25H2 Installer"
    $title.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
    $title.ForeColor = [System.Drawing.Color]::FromArgb(65, 105, 225)
    $title.AutoSize = $true
    ...
    switch ($selectedMode) {
        "advanced" {
            ...
            if ($resp -eq [System.Windows.Forms.DialogResult]::Yes) {
                Apply-Bypass
                [System.Windows.Forms.MessageBox]::Show("Bypass registry keys applied.","Emir Tech Tools",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information) | Out-Null
            }
        }
        "reset" {
            $resp = [System.Windows.Forms.MessageBox]::Show(
            ...
            if ($resp -eq [System.Windows.Forms.DialogResult]::Yes) {
                Reset-Bypass
                [System.Windows.Forms.MessageBox]::Show("Registry reset completed.","Emir Tech Tools",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information) | Out-Null
                exit
            }
        }
        default { }
